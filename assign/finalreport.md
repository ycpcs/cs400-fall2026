...
The **references** section should list the references that you have used throughout the document.  You must place references in the document whenever you refer to tools and technologies that you have used, as well as code libraries, sources for important design and technical information, etc.
...
There should be sample technical reports in the Google Drive for last year's project(s).
