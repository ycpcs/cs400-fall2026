---
layout: default
title: "Assignment 2: Weekly Journals, Status Reports, and Demos"
---
...
Each team member will maintain a (shared) Weekly Journal as a Google doc on your team's drive.  Your journal entries should summarize your work for the week.

They are due by 9:00am (before class) on the day of your project presentations, and **MUST** address the following points:

* **Daily** entries of work accomplished, including notes, screen captures, links to external resources, and whatever information may be relevant to the research and work that you investigated/accomplished. Throughout the project, your weekly journal will accumulate your research, your accomplishments, and the effort you have put forth. *If work isn't documented in your journal, you will not receive credit for doing it.*
* **A self-assessment grade (0-5) on the work you accomplished over the past week justified by the daily entries**
* A *brief* summary of what your TEAM accomplished in the past week
* A *brief* summary of **your** individual contributions to the team progress in the past week
* A *list* of challenges you faced that impeded your progress, and explain how you dealt (or did not deal) with them
* **A list of tasks you intend to accomplish for the next week**
* **Links** to your major commits for the week. You can create a link to a commit by pasting the first 8 (or so) hex digits of its hash code from Github
...
* What *challenges* were encountered and *briefly* if they were resolved or not
* What *will* be accomplished over the next week
...
For each weekly meeting and periodically for the weekly journal, each student (individually) will receive one of the following evaluations:

* **Exceeds expectations**: We think you are making an extraordinary contribution to your project, and that overall, your team is on course to demonstrate a very strong final product.
...
* **Extremely weak**: We observed almost no or mostly trivial work performed over the last week, which resulted in very little progress. 
* **Unacceptable**: No work was performed over the last week.

**NOTE: Late weekly journal entries will receive a reduced evaluation from the one they would have otherwise received.**